...
public partial class CenterEditClaud : ComponentBase
{
    ...
    {
        if (string.IsNullOrEmpty(Model?.CenterCode))
            return "theme-default";

        // استخدام الحرف الأخير أو رقم الكود لتحديد اللون
        var code = Model.CenterCode.Trim().ToUpper();
        var lastChar = code.LastOrDefault();

        return lastChar switch
        {
            '0' or '1' or 'A' or 'B' => "theme-1",
            '2' or '3' or 'C' or 'D' => "theme-2",
            '4' or '5' or 'E' or 'F' => "theme-3",
            '6' or '7' or 'G' or 'H' => "theme-4",
            '8' or '9' or 'I' or 'J' => "theme-5",
            _ => "theme-default"
        };
    }
}
